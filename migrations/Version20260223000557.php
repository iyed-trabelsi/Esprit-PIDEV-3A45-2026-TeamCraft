 ...
 */
final class Version20260223000557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, date_expiration DATE NOT NULL, description LONGTEXT DEFAULT NULL, poster VARCHAR(255) DEFAULT NULL, game VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, rank VARCHAR(255) NOT NULL, nb_player_recruited INT NOT NULL, team_id INT NOT NULL, INDEX IDX_29D6873E296CD8AE (team_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, game VARCHAR(100) DEFAULT NULL, game_rank VARCHAR(100) DEFAULT NULL, role VARCHAR(100) DEFAULT NULL, region VARCHAR(100) DEFAULT NULL, status VARCHAR(50) DEFAULT NULL, selected_games JSON DEFAULT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_98197A65A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE postulation (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(50) NOT NULL, message LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_DA7D4E9BA76ED395 (user_id), INDEX IDX_DA7D4E9B53C674EE (offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
