...
public function index(Request $request, \App\Repository\OfferRepository $offerRepository): Response
    ...
    public function postuler(int $id, Request $request, \App\Repository\OfferRepository $offerRepository, \App\Repository\PostulationRepository $postulationRepository, \Doctrine\ORM\EntityManagerInterface $entityManager, \App\Service\SmartMatchingService $smartMatchingService): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($cvFile) {
                ...
                try {
                    ...
                    $postulation->setCvFileName($cvFileName);
                } catch (\Exception $e) {
