...
class ProfileController extends AbstractController
{
    ...
    public function index(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            // Handle competitive rank creation (Create Rank modal)
            if ($request->request->has('competitive_game')) {
                $competitiveRank = new \App\Entity\CompetitiveRank();
                $competitiveRank->setGame($request->request->get('competitive_game'));
                $competitiveRank->setPrincipalRole($request->request->get('principal_role'));
                $competitiveRank->setSkillLevel($request->request->get('skill_level'));
                $competitiveRank->setExperience($request->request->get('experience'));
                $competitiveRank->setAvailability($request->request->get('availability'));
                $competitiveRank->setRegion($request->request->get('region'));
